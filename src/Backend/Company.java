...
//			System.out.println(date);
			...
			sql="insert into BPO.Employee(company_id,first_name,designation,department,dob,doj,salary,account_number,last_name) values("+company_id+",'"+first_name+"','"+designation+"','"+department+"','"+dob+"','"+doj+"',"+salary+","+account_number+",'"+last_name+"')";
